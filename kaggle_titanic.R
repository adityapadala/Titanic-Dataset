...
#first prediction to be submitted:
...
my_tree_five <- rpart(Survived ~ Pclass+Sex+Age+SibSp+Parch+Fare+Embarked, data = train_new, method = "class")
...
#to find which variables are influencing the predictor the most. It gives the MeanDecreaseAccuracy and MeanDecreaseGini
